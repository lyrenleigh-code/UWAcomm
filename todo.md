...
### SC-FDE (P1) + OFDM (P2) — 去oracle化完成 ✅

| 体制 | static | fd=1Hz | fd=5Hz 5dB | fd=5Hz 10dB | fd=5Hz 15/20dB |
|------|--------|--------|-----------|------------|----------------|
| SC-FDE(BEM) | 0% | 0% | 1.42% | 0.02% | 0% |
| OFDM(BEM) | 0% | 0% | 1.42% | 0.02% | 0% |

信道估计：静态GAMP(CP段训练) + 时变BEM(DCT)(跨块CP导频) + 首达径sync
