...
**V4.1修复**: static高SNR发散(46-49%)——根因GAMP消息传递震荡，改用OMP
**fd=1Hz@25dB**: 3.81%非单调回升（20dB是0%），疑DD高SNR发散
...
### 🔶 P2→V4.1: OFDM — static修复，fd=1Hz待优化
- V4.1: static信道估计由GAMP改为OMP，修复高SNR发散
- static: 0%@10dB+，fd=1Hz: 0%@20dB但25dB回升3.81%
- 待排查fd=1Hz@25dB非单调问题
...
| 🔶 进行 | **OFDM端到端V4.1** | **static修复** | OMP替代GAMP修复高SNR发散，fd=1Hz@25dB待排查 |
