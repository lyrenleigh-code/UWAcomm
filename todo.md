...
| **SC-TDE fd=1Hz α estimator fix** | 🆕 2026-04-25 | spec `2026-04-25-sctde-fd1hz-alpha-estimator-fix.md`；H4 后续 fix；4 步（量化偏差 / R1-R4 根因 / fix V1.2 / 验证）；目标 SNR=20 mean ≤1.5% + 灾难率 ≤15% + 单调；非目标 SNR=10 残余 |
