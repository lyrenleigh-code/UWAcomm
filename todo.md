...
**已知问题**: static在15dB+突然崩溃(~46-49%)，非单调，疑Turbo迭代发散
**fd=1Hz可工作**: 10dB+接近0%，与SC-FDE V4.0同量级
...
### 🔶 P2→V4.0: OFDM — 代码完成，待测试
- V4.0代码完成，对齐SC-FDE V4.0两级分离架构
- 帧结构/多普勒估计/同步全部改为盲处理
- 待MATLAB测试验证BER
...
| 🔶 进行 | **OFDM端到端V4.0改造** | **代码完成** | 去oracle dop_rate, 套用V4.0帧结构，待MATLAB测试 |
